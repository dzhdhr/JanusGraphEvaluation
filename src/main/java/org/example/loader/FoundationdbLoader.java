...
public class FoundationdbLoader implements GraphLoader{
    private JanusGraph graph;
    ObjectMapper objectMapper ;
    public FoundationdbLoader(){
        objectMapper = new ObjectMapper();
        graph = JanusGraphFactory.open("src/main/resources/janusgraph-foundationdb.properties");
    }
    @Override
